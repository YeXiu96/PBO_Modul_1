...
public class Main {
    ...
    public static void main(String[] args) {
        Main main = new Main();
        Admin.studentList = new Student[10];
        ...
        Admin.addStudent("Bagas Drible", "Teknik", "202210370311218", "Industri");
        Admin.studentCount++;
        Admin.addStudent("Dava Femboy", "FISIP", "201910330211839", "Ilmu Komunikasi");
        Admin.studentCount++;
        Admin.addStudent("Alvin Cipmunk", "FIKES", "2020103703212920", "Kedokteran");
        Admin.studentCount++;
    ...
    public void checkNim(String nim) {
        ...
        for (int i = 0; i < Admin.studentCount; i++) {
            if (Admin.studentList[i] != null && Admin.studentList[i].nim.equals(nim)) {
